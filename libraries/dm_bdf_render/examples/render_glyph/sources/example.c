...
/*   Updated: 2022/07/23 14:27:55 by dmalesev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
", ' ');
	...
	glyph = find_matching_encoding(argv[2][0], font);
	print_font_params(font);
	print_font_properties(&font->properties);
	print_glyph_info(glyph);
	render_glyph(argv[2][0], &(t_pxl){&put_pixel, scrn}, &(t_2i){0, 0}, font);
	put_screen(scrn);
	return (0);
}
