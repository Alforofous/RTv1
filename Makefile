...
#    Updated: 2022/06/17 11:21:30 by dmalesev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UNAME = $(shell uname)
ifeq ($(UNAME), Darwin)
LIBS =	-lmlx -framework AppKit -framework OpenGL $(LIBFT) $(DM_2D)
endif
ifeq ($(UNAME), Linux)
LIBS =	-O -lmlx_Linux -lXext -lX11 -lm $(LIBFT) $(DM_2D)
endif
...
INCLUDES = -I$(HEADERS_DIRECTORY) -I$(LIBFT_HEADERS) -I$(DM_2D_HEADERS) -I./minilibx/

ASSERT_OBJECT = && echo "$@ $(YELLOW)$(BOLD) ✔$(RESET)" || echo "$@ $(RED)$(BOLD)✘$(RESET)"

all: $(NAME)

$(NAME): $(LIBFT) $(DM_2D) $(OBJECTS_DIRECTORY) $(OBJECTS)
