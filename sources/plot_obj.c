...
void	plot_object_vert(t_utils *utils, t_obj *obj, t_3f *offset, t_uint color)
{
	t_3f	point;
	int		i;
	...
	{
		point = get_points(utils, &(t_3f){obj->vertices[i].a + offset->x,
...
void	plot_object(t_utils *utils, t_obj *obj, t_3f *os, t_uint color)
{
	t_3f	p[3];
	t_3f	light;
	float	l;
	...
	{
		p[0] = get_points(utils, &(t_3f){obj->vertices[obj->faces[i].a[0] - 1].a + os->x,
				obj->vertices[obj->faces[i].a[0] - 1].b + os->y,
				obj->vertices[obj->faces[i].a[0] - 1].c + os->z}, &utils->rot, &utils->proj);
		p[1] = get_points(utils, &(t_3f){obj->vertices[obj->faces[i].b[0] - 1].a + os->x,
				obj->vertices[obj->faces[i].b[0] - 1].b + os->y,
				obj->vertices[obj->faces[i].b[0] - 1].c + os->z}, &utils->rot, &utils->proj);
		p[2] = get_points(utils, &(t_3f){obj->vertices[obj->faces[i].c[0] - 1].a + os->x,
				obj->vertices[obj->faces[i].c[0] - 1].b + os->y,
				obj->vertices[obj->faces[i].c[0] - 1].c + os->z}, &utils->rot, &utils->proj);
		//if (obj == &utils->cube)
		//{
			light.x = 0.5f;
			light.y = 0.0f;
